...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_ARTIST = "artist"; //maybe points to a table
    private static final String KEY_ALBUM = "album";
    private static final String KEY_ALBUM_ARTIST = "albumArtist"; //maybe points to a table
	...
	public void onCreate(SQLiteDatabase db) {
		String CREATE_FILETYPE_TABLE = "CREATE TABLE " + TABLE_FILETYPES + "("
				+ KEY_FILETYPE_ID +	"INTEGER	PRIMARY KEY		AUTOINCREMENT	NOT NULL,"
				+ KEY_FILETYPE +	"TEXT		NOT NULL		UNIQUE"
				+ ")";
		...
		String CREATE_SONGS_TABLE = "CREATE TABLE " + TABLE_SONGS + "("
				...
				+ KEY_FILETYPE_ID +	" INTEGER	NOT NULL		REFERENCES " + TABLE_FILETYPES + "(" + KEY_FILETYPE_ID + ")," 
				...
				+ KEY_ALBUM_ART + 	" TEXT		DEFAULT NULL" // not sure if I want this
				+ ")"; 
	...
	public void addSong(Song song) {
		...
		values.put(KEY_SONG_PATH, song.uri.getPath());
	...
	public Song getSongById(int id) {
		...
		SongUnused song = new SongUnused(Uri.parse(cursor.getString(1))); //needs to be changed
