...
public class SongList extends ListActivity implements
		LoaderManager.LoaderCallbacks<Cursor> {
	public static final String START_SCAN = new String("start_scan");

	//TODO use all possible extensions
	private static final String[] musicFileTypes = { ".mp3" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		boolean startScan = getIntent().getBooleanExtra(START_SCAN, false);

		if (startScan) {
			Intent fullScanIntent = new Intent(this, FileScanService.class);
			startService(fullScanIntent);
		}
		...
		adapter = new SimpleCursorAdapter(this,
				android.R.layout.simple_list_item_1, dbHandler.getTagList(
						DatabaseHandler.KEY_ARTIST, filter, true), fromColumns,
				toViews, 0);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(com.waves.R.menu.music_library_main, menu);
		return true;
	}
